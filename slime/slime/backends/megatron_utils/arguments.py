...
def _hf_validate_args(args, hf_config):
    ...
    for hf_config_name, megatron_config_name, compare_fn in [
        ...
        # Megatron versions differ on the norm-eps attribute name (norm_epsilon vs
        # layernorm_epsilon); check both and, crucially, guard with hasattr(args, ...)
        # below so a missing attribute is skipped instead of raising AttributeError.
