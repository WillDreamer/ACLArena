...
```bash
PYTHONPATH=/data/user/Megatron-LM torchrun tools/convert_hf_to_torch_dist.py \
    ${MODEL_ARGS[@]} \
    --hf-checkpoint /data/user/Qwen/Qwen3.5-35B-A3B-Base \
    --save /data/user/Qwen3.5-35B-A3B-Base_torch_dist
```
