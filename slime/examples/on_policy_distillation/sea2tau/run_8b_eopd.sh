...
#
# usage: cd /data/user/slime && bash examples/on_policy_distillation/sea2tau/run_8b_eopd.sh
...
WANDB_GROUP="eopd_search2tau_bs_${ROLLOUT_BATCH_SIZE}"
...
CKPT_ARGS=(
   ...
   --no-load-rng
   --finetune
   --save          ${MODEL_ROOT}/MultiStageRL/OPD/Qwen3-8B-Base-TauSFT-Tau_EOPD_Search/
   --save-interval 30
)
