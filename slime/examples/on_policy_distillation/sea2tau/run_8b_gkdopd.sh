...
#
# usage: cd /data/user/slime && bash examples/on_policy_distillation/sea2tau/run_8b_gkdopd.sh
...
CKPT_ARGS=(
   ...
   --no-load-rng
   --finetune
   --save          ${MODEL_ROOT}/MultiStageRL/OPD/Qwen3-8B-Base-TauSFT-Tau_GKD_Search/
   --save-interval 5
