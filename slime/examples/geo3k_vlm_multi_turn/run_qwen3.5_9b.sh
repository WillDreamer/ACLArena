...
# Run the geo3k VLM multi-turn RL task with Qwen3.5-9B-Base.
#
...
WANDB_GROUP="geo3k_vlm_qwen3.5_9b"
SAVE_DIR="${MODEL_ROOT}/MultiStageRL/Qwen3.5-9B-Base-geo3k"
...
CKPT_ARGS=(
   ...
   # start the policy + reference model from the base torch_dist checkpoint
...
if [ -n "${WANDB_API_KEY}" ]; then
   WANDB_ARGS=(
      --use-wandb
      --wandb-project geo3k-vlm-qwen3.5-9b
