...
class SFTDataset(Dataset):
    ...
    def __init__(
        ...
        out_file = f"/data/user/OpenSWE_SFT/SFT_data_pre_process/{file_name}_processed_{tokenzier_name}_w_fc.jsonl"
...
if __name__ == "__main__":
    ...
    data_file = "/data/user/OpenSWE_SFT/openswe_sft.jsonl"
    train_data = blending_datasets(data_file)
    print(train_data)

    tokenizer_path ="/data/user/Qwen3-Coder-30B-A3B-Instruct"
